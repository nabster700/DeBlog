[allow-download]
	<span class="attachment">
		<a class="btn btn-outline-primary btn-sm" href="{link}" data-toggle="tooltip" title="[count] [{size}] (cкачиваний: {count})[/count]"><i class="fa fa-download" aria-hidden="true"></i> {name}</a>
