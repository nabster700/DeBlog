      ...
      <div class="card w-100 mb-5">
         ...
         <div class="card-footer">
            <div class="btn-group w-100">
               <a href="/index.php?do=users" class="btn btn-outline-primary w-50">Пользователи</a>
               <a href="/index.php?do=lastcomments" class="btn btn-outline-primary w-50">Комментарии</a>
            </div>
         </div>
      </div>
   </div>
