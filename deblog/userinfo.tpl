            ...
            <div class="col-md-2">
                <a href="#">
                    <div role="status" style="position: absolute;margin: 10px;">
                        ...
                        <span class="badge badge badge-danger">Офлайн</span>[/offline]
                    </div>
...
<div class="card mb-2 w-100">
    <div class="card-body p-2">
        <div class="row">
            <div class="col-md-6">
                [not-group=5]{pm}[/not-group] [group=5]
                <a href="#" class="list-group-item list-group-item-action" data-toggle="modal" data-target="#pm123"><i class="icon-speech mr-2"></i>Написать ПС</a>[/group]
            </div>
