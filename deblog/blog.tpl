<div class="col-md-6">
<div class="card mb-4"[fixed] style="border-radius: 0.2rem;box-shadow: 0 8px 40px -10px rgba(0, 0, 0, 0.4);border: 3px solid #5f9cfe;border-color: #a5aff9;"[/fixed]>
  <div class="card-body p-3">
    <div class="row">
        ...
        [xfnotgiven_poster_one]<img src="{THEME}/dleimages/no_image.jpg" class="xfieldimage poster_one" alt="{title}">[/xfnotgiven_poster_one]
            </a>
       </div>
        <div class="col-md-12">
		[not-group=5]
